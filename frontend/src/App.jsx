...
import Addmeeting from './supervisor/Addmeetting'
import CommettiStudents from './commettie/CommettiStudents'
...
import AllPresentation from './Presentation/AllPresentation'
import Addpresentation from './Presentation/Addpresentation'
import GenerateReport from './Page/GenerateReport'
import UploadThesis from './Page/UploadThesis'
import DigitalRepository from './pages/DigitalRepository'
        ...
        <Router>
            <UserProvider>
                <Routes>
                    ...
                    <Route path="/Addmeeting/:student_id/" element={<Addmeeting />} />
                    <Route path='/Drepository' element={<DigitalRepository/>}/>
                    <Route path="/commettistudents" element={<CommettiStudents />} />
                    ...
                    >
                        ...
                        <Route path='admin/UploadThesis' element={<UploadThesis />} />
                        <Route path="admin/Viewdac" element={<Viewdac />} />
                        <Route path="admin/Viewdac/Adddac" element={<Adddac />} />
                        <Route path="admin/Presentation" element={<AllPresentation />} />
                        <Route path="admin/addpresentation" element={<Addpresentation />} />
